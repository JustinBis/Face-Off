...
export default class TakePicture extends React.Component {
	...
	render() {
		// Use Twemoji to convert the emoji to an img tag using a .svg as the source
		...
		var view = (<div id="take-picture">
			...
			<div className="emoji-container">
				<emoji className="big">{this.state.selected_emoji}</emoji>
			</div>
			<div>
				<button onClick={this.newRandomEmoji}>New Emoji</button>
				<button onClick={this.takePicture}>Take a Selfie</button>
			</div>
			</div>);

		// if(this.state.picture_data)
		// {
		// 	view = (<ReviewPicture />);
		// }
